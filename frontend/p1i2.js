document.addEventListener("DOMContentLoaded", () => {
  ...
  const link2 = document.getElementById("page1Item2NoItem");
  const link3 = document.getElementById("AddBmkForP1I2");

  const inputs1 = link3.querySelectorAll("input");
  const addButton1 = link3.querySelector("div[role='button']");
  const clearButton1 = document.getElementById("p1clearb2");
  ...
  clearButton1.addEventListener("click", function () {
    ...
    localStorage.setItem("page0Item2", serilized_bookmark);
    toggleLinks1("nexist");
  });
